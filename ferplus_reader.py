...
class FERPlusParameters():
    ...
    def __init__(self, target_size, width, height, training_mode="majority", shuffle=True):
...
class FERPlusReader(object):
    ...
    def get_image_label(self):
        ...
        for idx in range(data_size):
            ...
            #print('index is: %d and idx is %d' %(index, idx))
            img_dir = self.data[index][0]
            inputs.append(img_dir)
            labels.append(self._process_target(self.data[index][2]))
